...
<div class="topbar">
    ...
    <div class="topbar-divider"></div>
    <span class="topbar-page">Scoring Físico</span>
</div>
""", unsafe_allow_html=True)

st.markdown("""
<div style="padding-top:6px; padding-bottom:4px;">
    <span style="font-size:22px; font-weight:900; color:white;">SCORING FÍSICO</span>
    ...
    if not partidos_s4:
        ...
        if not filas_ranking:
            ...
            with r_sl2:
                ...
                cant = st.radio("", [5, 15, 25], index=1, horizontal=True,
